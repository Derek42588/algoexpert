...
1 <= itemCount[i] <= 10^9
*/
function questionOne(itemCount, target) {
    var sum = 0;
    for (var _i = 0, itemCount_1 = itemCount; _i < itemCount_1.length; _i++) {
        var num = itemCount_1[_i];
        if (sum < target) {
            sum += num;
        }
        else {
...
//# sourceMappingURL=PI-question-one.js.map